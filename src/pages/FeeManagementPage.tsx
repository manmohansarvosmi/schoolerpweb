...
import FeeManagementSection from "@/components/FeeManagementSection";
      ...
      <main className="flex-1 pt-24 pb-10">
        ...
        <section className="container mt-12 mb-24 max-w-4xl">
          <div className="rounded-3xl bg-primary/5 border border-primary/20 p-10 text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to simplify your school finances?</h2>
            <p className="text-lg text-muted-foreground mb-8">
              Automate your fee collection and management today with our easy-to-use platform.
            </p>
            <Link to="/register">
